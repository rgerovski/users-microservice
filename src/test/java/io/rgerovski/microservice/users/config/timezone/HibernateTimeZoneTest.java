package io.rgerovski.microservice.users.config.timezone;

import io.rgerovski.microservice.users.UsersMicroserviceApp;
import io.rgerovski.microservice.users.repository.timezone.DateTimeWrapper;
import io.rgerovski.microservice.users.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = UsersMicroserviceApp.class)
