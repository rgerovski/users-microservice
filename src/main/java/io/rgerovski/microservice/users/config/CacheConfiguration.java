...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("UsersMicroservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("UsersMicroservice");
        ...
        config.getMapConfigs().put("io.rgerovski.microservice.users.domain.*", initializeDomainMapConfig(jHipsterProperties));
